...
*/
const static inline MultilevelPointer mlp_OrigCallRefreshFunction{ { 0xA76708 } };  // old 3073 ptr: 0xA785A4 
...
*/
const static inline MultilevelPointer mlp_CustomGameInfoArrayStart{ { 0x03F639A0 , 0x40, 0x0 } }; // old 3073 ptr: 0x03F7FF18, 0x40, 0x0
...
/*
 ...
 Confirm by setting a breakpoint. Should get hit when you click refresh or load into the CGB from the main menu.
*/
const MultilevelPointer mlp_OrigUpdateCustomGameArray{ { 0x279FD0 } }; // old 3073 ptr:  0x2705C8